...
<div class="page-content-area">
	...
	<h1>
		...
		<div class="row">
				<div class="col-xs-12">
						<form class="form-horizontal" action="<?php echo U('Home/Deport/update_info');?>" id="form_info" method="post" role="form">
								<input type="hidden" name="deport[id]" id="deport_id" value="<?php echo ($deport["id"]); ?>" />
...
<?php } ?>
								...
								<div class="form-group">
	<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">部门名称：</label>

	<div class="col-sm-9">
		<input type="text" id="deport_name" name="deport[name]" placeholder="部门名称" class="col-xs-10 col-sm-5" value="<?php echo ($deport["name"]); ?>" />
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<textarea name="deport[content]" id="deport_content" placeholder="描述" rows="5" cols="50"><?php echo ($deport["content"]); ?></textarea>
	</div>
</div>
<div class="space-4"></div>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<input type="text" id="deport_rank" name="deport[rank]" placeholder="排序" class="col-xs-10 col-sm-5" value="<?php echo ($deport["rank"]); ?>" />
	</div>
</div>
<div class="space-4"></div>
