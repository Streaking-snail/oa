...
<div class="page-content-area">
	...
	<h1>
	   ...
	   <div class="row">
				<div class="col-xs-12">
					<form class="form-horizontal" action="<?php echo U('Classification/create_info');?>" method="post" role="form">
...
<?php } ?>
	...
	<div class="col-sm-9">
		<select name="classification[subcategory_id]" id="classification_category_id" vel="<?php echo U('Product/get_sub_categories');?>">
			<?php foreach($categories as $value){ ?>
				<?php if( $value['id']==$classification['category_id'] ){ ?>
...
<div class="form-group">
	<label class="col-sm-3 control-label no-padding-right" for="form-field-1">选择系列：</label>
	<div class="col-sm-9">
		<select name="classification[sub_category_id]" id="classification_sub_category_id">
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<input type="text" id="classification_name" name="classification[name]" placeholder="类别名称" class="col-xs-10 col-sm-5" value="<?php echo ($classification["name"]); ?>" />
	</div>
</div>
<div class="space-4"></div>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<textarea name="classification[content]" id="classification_content" placeholder="描述" rows="5" cols="50"><?php echo ($classification["content"]); ?></textarea>
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<input type="text" id="classification_rank" name="classification[rank]" placeholder="排序" class="col-xs-10 col-sm-5" value="<?php echo ($classification["rank"]); ?>" />
	</div>
</div>
