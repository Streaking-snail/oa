...
<div class="page-content-area">
	...
	<h1>
		...
		<div class="row">
				<div class="col-xs-12">
						<form class="form-horizontal" action="<?php echo U('Menus/update_info');?>" method="post" role="form" enctype="multipart/form-data">
							<input type="hidden" name="menu[id]" id="menu_id" value="<?php echo ($menu["id"]); ?>" />
...
<?php } ?>
	...
	<div class="col-sm-9">
		<input type="text" id="menu_name" name="menu[name]" placeholder="名称" class="col-xs-10 col-sm-5" value="<?php echo ($menu["name"]); ?>" />
	</div>
</div>
<div class="space-4"></div>

<div class="form-group">
	<label class="col-sm-3 control-label no-padding-right" for="form-field-tags">是否显示：</label>
	<div class="col-sm-9">
		 <select name="menu[is_show]" id="menu_is_show">
		 	 <?php if( intval($menu['is_show'])==1 ){ ?>
...
<div class="form-group">
	<label class="col-sm-3 control-label no-padding-right" for="form-field-tags">说明：</label>
	<div class="col-sm-9">
		<textarea name="menu[content]" id="menu_content" placeholder="说明" rows="5" cols="50"><?php echo ($menu["content"]); ?></textarea>
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<input type="text" id="menu_rank" name="menu[rank]" placeholder="排序" class="col-xs-10 col-sm-5" value="<?php echo ($menu["rank"]); ?>" />
	</div>
</div>
<div class="space-4"></div>
							<div class="clearfix form-actions">
								<div class="col-md-offset-3 col-md-9">
									<button class="btn btn-info" id="btn" type="submit" vel="edit">
