						...
						<div class="profile-user-info profile-user-info-striped">
								<div class="profile-info-row">
									...
									<div class="profile-info-value">
										<span class="editable editable-click" id="username"><?php echo ($p_type["name"]); ?></span>
									</div>
								</div>
								...
								<div class="profile-info-row">
									...
									<div class="profile-info-value">
										<?php foreach( $Ptype->get_status($p_type['id']) as $k=>$v ){ if($k!=0){ echo "->".$v['name']; }else{ echo $v['name']; } } ?>
									</div>
								</div>

								<div class="profile-info-row">
									<div class="profile-info-name">流程说明</div>

									<div class="profile-info-value">
										<?php echo ($p_type["content"]); ?>
									</div>
								</div>
						</div>
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								<?php if( D('Roles')->is_power('Ptypes', 'edit', $user_info['id']) || $this->user_info['is_admin']==1 ){ ?>
									<a href="<?php echo U('Ptypes/edit', array('id'=>$p_type['id']));?>">
