...
<div class="page-content-area">
	...
	<div class="row">
		<div class="col-xs-12">
			<form class="form-horizontal" action="<?php echo U('Home/Roles/update_info');?>" method="post" role="form">
				<input type="hidden" name="role[id]" id="role_id" value="<?php echo ($role["id"]); ?>" />
