...
<div class="page-content-area">
	...
	<h1>
		...
		<div class="row">
				<div class="col-xs-12">
						<form class="form-horizontal" action="<?php echo U('Category/update_info');?>" method="post" role="form">
							<input type="hidden" name="category[id]" id="category_id" value="<?php echo ($category["id"]); ?>" />
...
<?php } ?>
							...
							<div class="form-group">
	<label class="col-sm-3 control-label no-padding-right" for="form-field-1">大类名称：</label>
	<div class="col-sm-9">
		<input type="text" id="category_name" name="category[name]" placeholder="大类名称" class="col-xs-10 col-sm-5" value="<?php echo ($category["name"]); ?>" />
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<textarea name="category[content]" id="category_content" placeholder="描述" rows="5" cols="50"><?php echo ($category["content"]); ?></textarea>
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<input type="text" id="category_rank" name="category[rank]" placeholder="排序" class="col-xs-10 col-sm-5" value="<?php echo ($category["rank"]); ?>" />
	</div>
</div>
