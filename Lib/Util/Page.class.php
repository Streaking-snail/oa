...
class Page {
    ...
    function __construct($Total_Size = 1, $Page_Size = 20, $Current_Page = 1, $List_Page = 6, $PageParam = 'page', $PageLink = '', $Static = FALSE) {
        ...
        $this->Page_tpl ['default'] = array('Tpl' => '<div class="pager">总计{recordcount}条数据&nbsp;&nbsp;当前第&nbsp;{pageindex}&nbsp;页&nbsp;/&nbsp;共&nbsp;{pagecount}&nbsp;页&nbsp;{first}{prev}{next}{last} 跳转到 {jump} 页</div>', 'Config' => array("first"=>"首页","prev"=>"上一页","next"=>"下一页","last"=>"尾页"));
